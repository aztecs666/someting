...
Reference full template: `E:/MLCollege/real data/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/MLCollege/real data/.codex/get-shit-done/templates/state.md`.
