...
<execution_context>
@E:/MLCollege/real data/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/MLCollege/real data/.codex/get-shit-done/workflows/check-todos.md`.
