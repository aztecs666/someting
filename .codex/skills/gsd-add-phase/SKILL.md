...
<execution_context>
@E:/MLCollege/real data/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@E:/MLCollege/real data/.codex/get-shit-done/workflows/add-phase.md`.
