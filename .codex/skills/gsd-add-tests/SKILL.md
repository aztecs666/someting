...
<execution_context>
@E:/MLCollege/real data/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @E:/MLCollege/real data/.codex/get-shit-done/workflows/add-tests.md end-to-end.
