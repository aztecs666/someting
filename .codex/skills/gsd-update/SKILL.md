...
<execution_context>
@E:/MLCollege/real data/.codex/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@E:/MLCollege/real data/.codex/get-shit-done/workflows/update.md`.
