...
<!-- For checkpoint task examples and patterns, see @E:/MLCollege/real data/.codex/get-shit-done/references/checkpoints.md -->
...
See `E:/MLCollege/real data/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/MLCollege/real data/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/MLCollege/real data/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
