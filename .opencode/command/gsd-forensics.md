...
<execution_context>
@E:/MLCollege/real data/.opencode/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @E:/MLCollege/real data/.opencode/get-shit-done/workflows/forensics.md end-to-end.
</process>
