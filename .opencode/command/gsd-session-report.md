...
<execution_context>
@E:/MLCollege/real data/.opencode/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/MLCollege/real data/.opencode/get-shit-done/workflows/session-report.md end-to-end.
</process>
